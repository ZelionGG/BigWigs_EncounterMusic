...
L.optionsDisclaimer = "This module is not affiliated with the BigWigs team. Please do not contact them for support regarding this AddOn."
...
if locale == "frFR" then
	...
	L.optionsDisclaimer = "Ce module n'est pas affilié à l'équipe BigWigs. Merci de ne pas les contacter pour le support concernant cet AddOn."
